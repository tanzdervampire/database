...
(function () {
    ...
    db.run('CREATE TABLE SHOW (ID INTEGER PRIMARY KEY AUTOINCREMENT, PRODUCTION_ID INTEGER NOT NULL, DAY DATE NOT NULL, TIME DATETIME DEFAULT NULL, TYPE TEXT NOT NULL);');
})();
...
Object.keys(shows).forEach((i) => {
    ...
    Object.keys(shows[i]).forEach((type) => {
        ...
        db.run('INSERT INTO SHOW (PRODUCTION_ID, DAY, TYPE) VALUES (?, ?, ?);', [
            getProductionId(i),
            date,
