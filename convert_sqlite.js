...
(function () {
    ...
    db.run('CREATE TABLE SHOW (ID INTEGER PRIMARY KEY AUTOINCREMENT, PRODUCTION_ID INTEGER NOT NULL, DAY DATE NOT NULL, TIME TEXT DEFAULT NULL, TYPE TEXT NOT NULL);');
})();
